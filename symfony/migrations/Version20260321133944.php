 ...
 */
final class Version20260321133944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statistique_logement (id INT AUTO_INCREMENT NOT NULL, annee_publication INT DEFAULT NULL, taux_de_chomage DOUBLE PRECISION DEFAULT NULL, taux_de_pauvrete DOUBLE PRECISION DEFAULT NULL, nombre_logement INT DEFAULT NULL, nombre_habitant INT DEFAULT NULL, departement_code VARCHAR(3) DEFAULT NULL, INDEX IDX_57E380456A333750 (departement_code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
